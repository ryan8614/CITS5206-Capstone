...
describe('Middleware Unit Tests', () => {
    ...
    it('should redirect to /signin if a protected route is accessed and the user is not authenticated', async () => {
        ...
        (req.nextUrl as any).pathname = '/authen/excel-edit';
    ...
    it('should redirect to /authen/excel-edit if a public route is accessed and the user is authenticated', async () => {
        (mockedCookies.get as jest.Mock).mockReturnValue({ value: 'test_session' });
        ...
        expect(NextResponse.redirect).toHaveBeenCalledWith(new URL('/authen/excel-edit', 'http://localhost:3000'));
        expect(NextResponse.next).not.toHaveBeenCalled();
    });
