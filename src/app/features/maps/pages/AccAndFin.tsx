...
import cellDataJson from "@/app/features/maps/data/accounting_finance_cells.json";
import layoutDataJson from "@/app/features/maps/data/accounting_finance_layout.json";
