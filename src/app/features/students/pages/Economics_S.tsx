...
export default function Economics_S() {
  const data = useFilteredStudents('Economics');
  ...
  return (
    <div className="h-auto p-4 bg-gray-100">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold">Economics Staff</h2>
        <Button
          type="primary"
          onClick={() => {
            console.log('Saving Economics data');
