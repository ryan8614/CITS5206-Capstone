...
export default function MO_S() {
  const data = useFilteredStudents('Mgmt & Orgs');
  ...
  return (
    <div className="h-auto p-4 bg-gray-100">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold">Management and Organisational Staff</h2>
        <Button
          type="primary"
          onClick={() => {
            console.log('Saving Management and Organisational data');
